...
`r fontawesome::fa("earlybirds", fill = "#FFB947", height = "3em", width = "2em")`

:::::::: columns
::: {.column width="20%"}

::: box-header
![](prep/humanslearning.png){fig-pos="b"}
:::
...
::::: box
:::: box-header
We are all just humans learning!

Welcome to the first iteration of the Humans Learning lessons. Each lesson is designed for a 5 - 10 minute virtual session conducted for EnCompass staff to expand their skills with data, and the means of learning is the R programming language. Each lesson will have learning objectives, some example code and explanation to demonstrate a technique or skill, and an open code chunk at the end for you to have some fun. This is all in the service of ensuring that we are all humans learning. Enjoy!
...
* Install and load packages in your RStudio console
