...
DT::datatable(bing, class = 'cell-border stripe', option = list(pageLength = 5))
```
...
DT::datatable(loughran, class = 'cell-border stripe', option = list(pageLength = 5))
...
ggplot(bing_sents) +
  geom_density(aes(score), color = "blue", lwd = 2, alpha = .4) +
  geom_density(data = loughran_sents, aes(score), color = "orange", lwd = 2, alpha = .4)
...
ggplot(bing_sents) +
  ...
  geom_density(data = llama_sents, aes(value), color = "red", lwd = 2, alpha = .6)
