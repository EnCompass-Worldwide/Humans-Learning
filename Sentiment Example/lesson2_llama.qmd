...
markdown_text <- ggtext::element_markdown("The <span style = 'color:#00457C;'>bing</span> 
                                          and Loughran-McDonald sentiment lexicons provide a much more positive take on the sentiments than the Llama sentiment analysis.")

ggplot(bing_sents) +
  geom_density(aes(score), color = "#00457C", alpha = .3) +
  geom_density(data = loughran_sents, aes(score), color = "#89C266", alpha = .3) +
  geom_density(data = llama_sents, aes(value), color = "#FF7C48", alpha = .3) +
  theme_minimal()+
  labs(title = "Comparison of sentiments with different methods", 
    subtitle = ggtext::element_markdown("The <span style = 'color:blue;'>bing</span> <span style = 'color:#0072B2;'>automatic</span> "),
